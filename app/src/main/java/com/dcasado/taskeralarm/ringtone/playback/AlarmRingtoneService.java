...
package com.dcasado.taskeralarm.ringtone.playback;
...
public class AlarmRingtoneService extends RingtoneService<Alarm> {
    ...
    private static final String ACTION_SNOOZE = "com.dcasado.taskeralarm.ringtone.action.SNOOZE";
    private static final String ACTION_DISMISS = "com.dcasado.taskeralarm.ringtone.action.DISMISS";
