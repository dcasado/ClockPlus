...
import com.dcasado.taskeralarm.ringtone.RingtoneActivity;
...
public abstract class RingtoneService<T extends Parcelable> extends Service {
    ...
    // public okay
    public static final String ACTION_NOTIFY_MISSED = "com.dcasado.taskeralarm.ringtone.action.NOTIFY_MISSED";
