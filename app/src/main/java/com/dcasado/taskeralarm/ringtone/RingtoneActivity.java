...
package com.dcasado.taskeralarm.ringtone;
...
public abstract class RingtoneActivity<T extends Parcelable> extends BaseActivity {
    ...
    public static final String ACTION_FINISH = "com.dcasado.taskeralarm.ringtone.action.FINISH";
    public static final String EXTRA_RINGING_OBJECT = "com.dcasado.taskeralarm.ringtone.extra.RINGING_OBJECT";
    public static final String ACTION_SHOW_SILENCED = "com.dcasado.taskeralarm.ringtone.action.SHOW_SILENCED";
