...
package com.dcasado.taskeralarm.alarms.background;
...
public class UpcomingAlarmReceiver extends BroadcastReceiver {
    public static final String ACTION_CANCEL_NOTIFICATION = "com.dcasado.taskeralarm.action.CANCEL_NOTIFICATION";
    public static final String ACTION_SHOW_SNOOZING = "com.dcasado.taskeralarm.action.SHOW_SNOOZING";
    public static final String EXTRA_ALARM = "com.dcasado.taskeralarm.extra.ALARM";
    private static final String TAG = "UpcomingAlarmReceiver";
    /*TOneverDO: not private*/
    private static final String ACTION_DISMISS_NOW = "com.dcasado.taskeralarm.action.DISMISS_NOW";
