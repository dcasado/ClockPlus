...
import com.dcasado.taskeralarm.alarms.data.AlarmsListCursorLoader;
...
public class AlarmsFragment extends RecyclerViewFragment<Alarm, BaseAlarmViewHolder, AlarmCursor,
    ...
    public static final String EXTRA_SCROLL_TO_ALARM_ID = "com.dcasado.taskeralarm.alarms.extra.SCROLL_TO_ALARM_ID";
