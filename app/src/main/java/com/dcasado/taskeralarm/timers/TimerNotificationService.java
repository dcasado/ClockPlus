...
public class TimerNotificationService extends ChronometerNotificationService {
    ...
    private static final String ACTION_CANCEL_NOTIFICATION = "com.dcasado.taskeralarm.timers.action.CANCEL_NOTIFICATION";
    public static final String ACTION_ADD_ONE_MINUTE = "com.dcasado.taskeralarm.timers.action.ADD_ONE_MINUTE";

    public static final String EXTRA_TIMER = "com.dcasado.taskeralarm.timers.extra.TIMER";
    private static final String EXTRA_CANCEL_TIMER_ID = "com.dcasado.taskeralarm.timers.extra.CANCEL_TIMER_ID";
