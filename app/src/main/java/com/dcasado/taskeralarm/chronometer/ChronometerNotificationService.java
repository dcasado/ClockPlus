...
package com.dcasado.taskeralarm.chronometer;
...
public abstract class ChronometerNotificationService extends Service {
    public static final String ACTION_START_PAUSE = "com.dcasado.taskeralarm.timers.action.START_PAUSE";
    public static final String ACTION_STOP = "com.dcasado.taskeralarm.timers.action.STOP";

    public static final String EXTRA_ACTION_ID = "com.dcasado.taskeralarm.extra.ID";
    /**
