...
package com.dcasado.taskeralarm.stopwatch.data;

import android.content.Context;

import com.dcasado.taskeralarm.data.SQLiteCursorLoader;
import com.dcasado.taskeralarm.stopwatch.Lap;
...
public class LapsCursorLoader extends SQLiteCursorLoader<Lap, LapCursor> {
    public static final String ACTION_CHANGE_CONTENT
            = "com.dcasado.taskeralarm.stopwatch.data.action.CHANGE_CONTENT";
