...
package com.dcasado.taskeralarm.stopwatch;
...
public class StopwatchNotificationService extends ChronometerNotificationService {
    ...
    public static final String ACTION_ADD_LAP = "com.dcasado.taskeralarm.stopwatch.action.ADD_LAP";
    public static final String ACTION_UPDATE_LAP_TITLE = "com.dcasado.taskeralarm.stopwatch.action.UPDATE_LAP_TITLE";

    public static final String EXTRA_LAP_NUMBER = "com.dcasado.taskeralarm.stopwatch.extra.LAP_NUMBER";
