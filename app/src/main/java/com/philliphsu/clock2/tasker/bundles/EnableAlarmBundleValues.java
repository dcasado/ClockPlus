 ...
 */
@ThreadSafe
public final class EnableAlarmBundleValues {
     ...
     */
    @NonNull
    public static int getAlarmId(@NonNull final Bundle bundle) {
        return bundle.getInt(BUNDLE_EXTRA_INT_ALARM_ID);
    }
     ...
     */
    private EnableAlarmBundleValues() {
